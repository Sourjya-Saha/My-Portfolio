...
const aboutData = [
  {
    ...
    info: [
      ...
      {
        title: "Web3",
        icons: [<SiSolidity key="solidity" />, <FaEthereum key="ethereum" />],
      },
    ],
  },
  {
...

  {
    ...
    info: [
      {
        title: "B.Tech , IT - Heritage Institute of Technology",
        stage: "2023 - 2027",
      },
      {
      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
        ...
        <div className="flex-1 flex flex-col justify-center">
          <motion.h2
            ...
            className="h2"
          >
            Where <span className="text-accent">Complex Code</span> Captivating{" "}
            <span className="text-accent">WebDesign</span>
          </motion.h2>
          <motion.p
