  ...
  slides: [
    {
      images: [
        ...
        {
          title: <Link href={''}>Twitter Clone</Link>,
          git:<Link href={''}><FaGithub/></Link>,
          live:<Link href={''}>LIVE PROJECT</Link>,
          path: '/musk-twitter-thumb-apr22.avif',
        },
        {
        ...
        {
          title: <Link href={''}>Airbnb Clone</Link>,
          git:<Link href={''}><FaGithub/></Link>,
          live:<Link href={''}>LIVE PROJECT</Link>,
          path: '/Airbnb.webp',
        },
            ...
            {slide.images.map((image , index)=>{
              ...
              <div className='relative rounded-lg overflow-hidden flex items-center justify-center group'>
                <div className='flex  rounded-lg items-center justify-center relative overflow-hidden'>
                  ...
                  {/*overlay gradient */}
                  <div className='absolute inset-0 bg-gradient-to-r from-[#18132f] via-[#e838cc] to-[#18132f] opacity-0 group-hover:opacity-90 transition-all duration-700'>
                    </div>
                    {/*title */}
